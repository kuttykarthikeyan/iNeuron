...
pay4= st.number_input("Insert the pay4")
pay5= st.number_input("Insert the pay5")
pay6= st.number_input("Insert the pay6")
...
billatm4=st.number_input("Insert the BillATM4")
billatm5=st.number_input("Insert the BillATM5")
billatm6=st.number_input("Insert the BillATM6")
...
payatm4=st.number_input("Insert the payatm4")
payatm5=st.number_input("Insert the payatm5")
payatm6=st.number_input("Insert the payatm6")
